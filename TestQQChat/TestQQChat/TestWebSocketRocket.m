...
static const uint16_t Kport = 7000;
...
@interface TestWebSocketRocket ()<SRWebSocketDelegate>{
...
@implementation TestWebSocketRocket

+ (instancetype)shareManager{

    static TestWebSocketRocket *manager  = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        manager = [[TestWebSocketRocket alloc] init];
        [manager initSocket];
    });
    return manager;
}
